...
* The original package name 'com.libkhadir.spring-native-image' is invalid and this project uses 'com.libkhadir.springnativeimage' instead.
...
```
$ docker run --rm -p 8080:8080 spring-native-image:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-native-image
```
